...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Notebook.version_counter'
        db.add_column('repchantest_notebook', 'version_counter',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Section.version_counter'
        db.add_column('repchantest_section', 'version_counter',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'AuthorAlias.version_counter'
        db.add_column('repchantest_authoralias', 'version_counter',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Page.version_counter'
        db.add_column('repchantest_page', 'version_counter',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Book.version_counter'
        db.add_column('repchantest_book', 'version_counter',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'CollectionNotebooks.version_counter'
        db.add_column('repchantest_collectionnotebooks', 'version_counter',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Notebook.version_counter'
        db.delete_column('repchantest_notebook', 'version_counter')

        # Deleting field 'Section.version_counter'
        db.delete_column('repchantest_section', 'version_counter')

        # Deleting field 'AuthorAlias.version_counter'
        db.delete_column('repchantest_authoralias', 'version_counter')

        # Deleting field 'Page.version_counter'
        db.delete_column('repchantest_page', 'version_counter')

        # Deleting field 'Book.version_counter'
        db.delete_column('repchantest_book', 'version_counter')

        # Deleting field 'CollectionNotebooks.version_counter'
        db.delete_column('repchantest_collectionnotebooks', 'version_counter')
    ...
    models = {
        ...
        'repchantest.authoralias': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'version_counter': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
