...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'AuthorAlias', fields ['name']
        db.delete_unique('repchantest_authoralias', ['name'])
    ...
    def backwards(self, orm):
        ...
        # Adding unique constraint on 'AuthorAlias', fields ['name']
        db.create_unique('repchantest_authoralias', ['name'])
